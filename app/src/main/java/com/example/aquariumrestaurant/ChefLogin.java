        ...
        try {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    if (FAuth.getCurrentUser().isEmailVerified()) {
                                        mDialog.dismiss();
                                        Toast.makeText(ChefLogin.this, "You are Signing In", Toast.LENGTH_SHORT).show();
                                        Intent z = new Intent(ChefLogin.this, ChefBottomNavigation.class);
                                        startActivity(z);
                                        finish();


                                    } else {
                                        ReusableCodeForAll.ShowAlert(ChefLogin.this, "", "Please verify your email address.");
                                    }
            ...
            txt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent Register = new Intent(ChefLogin.this, ChefRegisterationByEmail.class);
            ...
            Signinphone.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent q = new Intent(ChefLogin.this, ChefLoginByPhone.class);
                    startActivity(q);
                    finish();
                }
            });
