...
public class ChefOrderPrepared1 extends AppCompatActivity {

    private RecyclerView recyclerView;
    private List<ChefWaitingOrders1> chefWaitingOrders1List;
    private ChefOrderPrepared2 adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chef_order_prepared);
        recyclerView = findViewById(R.id.Recycle_orderstobeprepared);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(ChefOrderPrepared1.this));
        ...
        adapter = new ChefOrderPrepared2(ChefOrderPrepared1.this, chefWaitingOrders1List);
