...
public class ChefOrderPrepared2 extends RecyclerView.Adapter<ChefOrderPrepared2.ViewHolder> {

    private Context context;
    private List<ChefWaitingOrders1> chefWaitingOrders1list;

    public ChefOrderPrepared2(Context context, List<ChefWaitingOrders1> chefWaitingOrders1list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.chef_order3, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.Vieworder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, ChefOrderPreparedView1.class);
                intent.putExtra("RandomUID", random);
                context.startActivity(intent);
                ((ChefOrderPrepared1) context).finish();
            }
        });
    }
