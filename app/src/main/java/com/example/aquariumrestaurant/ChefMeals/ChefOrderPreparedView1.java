...
public class ChefOrderPreparedView1 extends AppCompatActivity {

    RecyclerView recyclerViewdish;
    private List<ChefWaitingOrders> chefWaitingOrdersList;
    private ChefOrderPreparedView2 adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chef_order_prepare_view);
        ...
        progressDialog = new ProgressDialog(ChefOrderPreparedView1.this);
        progressDialog.setCanceledOnTouchOutside(false);
        progressDialog.setCancelable(false);
        recyclerViewdish.setHasFixedSize(true);
        recyclerViewdish.setLayoutManager(new LinearLayoutManager(ChefOrderPreparedView1.this));
    ...
    private void CheforderdishesView() {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                        ...
                                                                        public void onSuccess(Void aVoid) {
                                                                            ...
                                                                            FirebaseDatabase.getInstance().getReference().child("Tokens").child(userid).child("token").addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                ...
                                                                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                    ...
                                                                                    AlertDialog.Builder builder = new AlertDialog.Builder(ChefOrderPreparedView1.this);
                                                                                    ...
                                                                                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                                        ...
                                                                                        public void onClick(DialogInterface dialog, int which) {
                                                                                            ...
                                                                                            dialog.dismiss();
                                                                                            Intent b = new Intent(ChefOrderPreparedView1.this, ChefOrderPrepared1.class);
                                                                                            startActivity(b);
                                                                                            finish();
                ...
                adapter = new ChefOrderPreparedView2(ChefOrderPreparedView1.this, chefWaitingOrdersList);
            ...
            public void onResponse(Call<MyResponse> call, Response<MyResponse> response) {
                if (response.code() == 200) {
                    if (response.body().success != 1) {
                        Toast.makeText(ChefOrderPreparedView1.this, "Failed", Toast.LENGTH_SHORT).show();
                    }
                }
