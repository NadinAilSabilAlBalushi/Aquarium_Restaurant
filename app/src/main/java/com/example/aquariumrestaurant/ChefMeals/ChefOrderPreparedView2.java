...
public class ChefOrderPreparedView2 extends RecyclerView.Adapter<ChefOrderPreparedView2.ViewHolder> {

    private Context mcontext;
    private List<ChefWaitingOrders> chefWaitingOrderslist;

    public ChefOrderPreparedView2(Context context, List<ChefWaitingOrders> chefWaitingOrderslist) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mcontext).inflate(R.layout.chef_order_view, parent, false);
