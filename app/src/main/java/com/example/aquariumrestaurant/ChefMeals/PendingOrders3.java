...
public class PendingOrders3 extends RecyclerView.Adapter<PendingOrders3.ViewHolder> {

    private Context context;
    private List<PendingOrders2> chefPendingOrders1list;
    private APIService apiService;
    String userid, dishid;


    public PendingOrders3(Context context, List<PendingOrders2> chefPendingOrders1list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        final PendingOrders2 chefPendingOrders1 = chefPendingOrders1list.get(position);
        ...
        holder.Vieworder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, ChefOrderMeals.class);
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                            final PendingOrders1 chefPendingOrders = snapshot.getValue(PendingOrders1.class);
                        ...
                        data.addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                PendingOrders2 chefPendingOrders1 = dataSnapshot.getValue(PendingOrders2.class);
