...
public class PendingOrders4 extends Fragment {

    private RecyclerView recyclerView;
    private List<PendingOrders2> chefPendingOrders1List;
    private PendingOrders3 adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        v = inflater.inflate(R.layout.fragment_chef_orders, null);
        ...
        adapter = new PendingOrders3(getContext(),chefPendingOrders1List);
