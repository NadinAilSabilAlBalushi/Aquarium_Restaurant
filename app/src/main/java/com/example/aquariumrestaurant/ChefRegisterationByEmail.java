...
import com.example.aquariumrestaurant.Reusable_Code.ReusableCodeForAll;
...
public class ChefRegisterationByEmail extends AppCompatActivity {

    String[] Future_Another_Country = {"Bahrain", "Qatar", "Saudi Arabia","United Arab Emirates", "Kuwait", "etc..."};


    String[] Muscat = {"Bawshar", "Seeb", "Al_Amarat", "Muttrah", "Ruwi", "Al-Mabellah", "Al-Hail", " Ar-Rusayl", "Al Khoudh", "Sultan Qaboos University"};

    String[] Bawshar = {"Al Khuwair", "Sultan Qaboos City", "Al Ghubra", "Ghala", "Al Ansab", };


    String[] Seeb = {"Al-Mabellah", "Al-Hail", " Ar-Rusayl", "Al Khoudh", "Sultan Qaboos University"};
    String[] Al_Amarat = {"Royal Opera House Muscat", "Al Alam Palace", "Al Zubair Museum"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        statespin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (statee.equals("Muscat")) {
                    ArrayList<String> list = new ArrayList<>();
                    for (String text : Muscat) {
                        list.add(text);
                    }
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(ChefRegisterationByEmail.this, android.R.layout.simple_spinner_item, list);

                    Cityspin.setAdapter(arrayAdapter);
                }
                if (statee.equals("Future: Another Country")) {
                    ArrayList<String> list = new ArrayList<>();
                    for (String text : Future_Another_Country) {
                        list.add(text);
                    }
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(ChefRegisterationByEmail.this, android.R.layout.simple_spinner_item, list);
        ...
        Cityspin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (cityy.equals("Bawshar")) {
                    ArrayList<String> listt = new ArrayList<>();
                    for (String text : Bawshar) {
                        listt.add(text);
                    }
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(ChefRegisterationByEmail.this, android.R.layout.simple_spinner_item, listt);
                    Suburban.setAdapter(arrayAdapter);
                }

                if (cityy.equals("Seeb")) {
                    ArrayList<String> listt = new ArrayList<>();
                    for (String text : Seeb) {
                        listt.add(text);
                    }
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(ChefRegisterationByEmail.this, android.R.layout.simple_spinner_item, listt);
                    Suburban.setAdapter(arrayAdapter);
                ...
                if (cityy.equals("Al_Amarat")) {
                    ArrayList<String> listt = new ArrayList<>();
                    for (String text : Al_Amarat) {
                        listt.add(text);
                    }
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(ChefRegisterationByEmail.this, android.R.layout.simple_spinner_item, listt);
                    Suburban.setAdapter(arrayAdapter);
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValid()) {
                    ...
                    final ProgressDialog mDialog = new ProgressDialog(ChefRegisterationByEmail.this);
                                        ...
                                        firebaseDatabase.getInstance().getReference("Chef")
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            AlertDialog.Builder builder = new AlertDialog.Builder(ChefRegisterationByEmail.this);
                                                            ...
                                                            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                ...
                                                                public void onClick(DialogInterface dialog, int which) {
                                                                    ...
                                                                    Intent b = new Intent(ChefRegisterationByEmail.this, ChefVerifyPhone.class);
                                                            ...
                                                            mDialog.dismiss();
                                                            ReusableCodeForAll.ShowAlert(ChefRegisterationByEmail.this, "Error", task.getException().getMessage());
        ...
        Emaill.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(ChefRegisterationByEmail.this, ChefLogin.class);
                startActivity(i);
                finish();
            }
        });
        ...
        Phone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent e = new Intent(ChefRegisterationByEmail.this, ChefLoginByPhone.class);
                startActivity(e);
                finish();
            }
        });
