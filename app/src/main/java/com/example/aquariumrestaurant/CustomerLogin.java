        ...
        try {
            ...
            txt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent Register = new Intent(CustomerLogin.this, CustomerRegisteration.class);
            ...
            Forgotpassword.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent a=new Intent(CustomerLogin.this, CustomerForgotPassword.class);
                    startActivity(a);
            ...
            SignInphone.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(CustomerLogin.this, CustomerLoginPhone.class);
