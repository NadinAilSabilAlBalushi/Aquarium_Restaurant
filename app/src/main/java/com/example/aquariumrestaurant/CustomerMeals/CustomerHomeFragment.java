...
import com.example.aquariumrestaurant.ChefMeals.UpdateDishModel;
...
public class CustomerHomeFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Animation animation = AnimationUtils.loadAnimation(getContext(), R.anim.navigation);
            ...
            public void run() {
                ...
                dataaa.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        State = Objects.requireNonNull(cust).getState();
                        City = Objects.requireNonNull(cust).getCity();
                        Sub = Objects.requireNonNull(cust).getSuburban();
                        customermenu();
                    }
