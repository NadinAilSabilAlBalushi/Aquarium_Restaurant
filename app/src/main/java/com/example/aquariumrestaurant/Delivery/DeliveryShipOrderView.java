package com.example.aquariumrestaurant.Delivery;
...
public class DeliveryShipOrderView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delivery_order_view1);
    ...
    private void deliveryfinalorders() {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                grandtotal.setText("OMR " + deliveryShipFinalOrders1.getGrandTotalPrice());
                address.setText(deliveryShipFinalOrders1.getAddress());
                name.setText(deliveryShipFinalOrders1.getName());
                number.setText("+986" + deliveryShipFinalOrders1.getMobileNumber());
