...
public class Delivery_registeration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Emaill.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(Delivery_registeration.this, DeliveryLogin.class);
                startActivity(a);
                finish();
            }
        });
    ...
    public boolean isValid() {
        ...
        if (TextUtils.isEmpty(confirmpassword)) {
            ...
            if (!password.equals(confirmpassword)) {
                Pass.setErrorEnabled(true);
                Pass.setError("The password does not match.");
            } else {
        ...
        if (TextUtils.isEmpty(house)) {
            ...
            houseno.setError("The field cannot be left blank");
        } else {
            isvalidhousestreetno = true;
        }
        if (TextUtils.isEmpty(Area)) {
            area.setErrorEnabled(true);
            area.setError("The field cannot be left blank");
        } else {
            isvalidarea = true;
        }
        if (TextUtils.isEmpty(Postcode)) {
            postcode.setErrorEnabled(true);
            postcode.setError("The field cannot be left blank");
        } else {
